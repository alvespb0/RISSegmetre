            ...
            >
                @forelse($serie->instance as $instance)
                    <div class="flex items-center justify-between p-4 hover:bg-accent/50 transition-colors group">
                        ...
                        <button
                            type="button"
                            wire:click="downloadImagemJpg('{{ $instance->instance_external_id }}')"
                            class="flex items-center gap-2 px-4 py-2 text-sm font-medium text-primary bg-primary/10 hover:bg-primary/20 rounded-md transition-colors whitespace-nowrap"
                        >
                            Baixar
